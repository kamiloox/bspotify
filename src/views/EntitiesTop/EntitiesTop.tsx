...
import EntitiesOrganizer from '../../components/organisms/EntitiesOrganizer/EntitiesOrganizer';
...
const EntitiesTop = () => {
  ...
  const { hasNextPage, data, fetchNextPage, entitiesOrganizerData, isLoading, isFetchingNextPage } =
  ...
  return (
    <MainTemplate padding="7px 20px" viewportHeight>
      <EntitiesOrganizer onSearch={(e) => setSearchText(e.target.value)} {...entitiesOrganizerData}>
